    ...
    const fetchProfile = async () => {
        ...
        try {
            ...
            if (error.response && (error.response.status === 401 || error.response.status === 403)) {
                ...
                navigate("/login", { 
                    state: { 
                        message: "Không thể truy cập thông tin quản lý" 
                    } 
                });
            }
        } finally {
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            ...
                            <div className="text-center mb-6">
                                ...
                                <p className="text-gray-600 text-xs leading-relaxed max-w-xs">
                                    {authChecking
                                        ? "Hệ thống đang xác thực quyền quản lý của bạn"
                                        : "Hệ thống đang chuẩn bị dữ liệu quản lý"}
                                </p>
                            </div>
                ...
                <div className={`${sidebarCollapsed ? "px-4 py-6" : "px-6 py-6"} relative bg-gradient-to-br from-indigo-600 via-indigo-700 to-blue-600 text-white overflow-hidden`}>
                    ...
                    <div className={`relative z-10 flex ${sidebarCollapsed ? "justify-center" : "items-center space-x-4"}`}>
                        <div className="flex-shrink-0 w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl shadow-lg border border-white/30 flex items-center justify-center group hover:scale-110 transition-transform duration-300">
                            <svg className="h-6 w-6 text-white transform transition-transform duration-700 ease-out group-hover:rotate-[360deg]" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        {!sidebarCollapsed && (
                            <div className="flex flex-col">
                                ...
                                <p className="text-sm font-medium text-indigo-200 tracking-wide">Quản lý Khối lượng</p>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <nav className="flex-1 py-6 px-4 overflow-y-auto bg-gradient-to-b from-white/80 to-white/95 backdrop-blur-sm">
                    {!sidebarCollapsed && (
                        <div className="mb-6 px-3">
                            <h2 className="text-sm font-bold text-gray-400 uppercase tracking-wider">Dashboard Quản lý</h2>
                        </div>
                    )}
                            ...
                            <li key={item.id}>
                                ...
                                >
                                    ...
                                    <div className={`${sidebarCollapsed ? "" : "mr-4"} relative z-10 transition-transform duration-300 group-hover:scale-110`}>
                                        <div className={`w-5 h-5 ${activeTab === item.id ? "text-white" : "text-indigo-600 group-hover:text-indigo-700"}`}>
                                ...
                                <div className="w-10 h-10 bg-gradient-to-r from-indigo-100 to-blue-100 rounded-xl flex items-center justify-center mr-4 shadow-md">
                                    <svg className="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={
                                            activeTab === "profile" ? "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" :
                                            activeTab === "duyet-ke-khai" ? "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" :
                                            activeTab === "thong-ke" ? "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" :
                                ...
                                <span className="relative">
                                    <span className="bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">
                                        {activeTab === "profile" ? "Thông tin cá nhân" :
                                         activeTab === "duyet-ke-khai" ? "Duyệt kê khai" :
                                         activeTab === "thong-ke" ? "Thống kê" : "Xuất báo cáo"}
                                    </span>
                            ...
                            <div className="flex items-center space-x-3 bg-gradient-to-r from-indigo-50 to-blue-50 px-4 py-3 rounded-xl border border-indigo-100 shadow-md backdrop-blur-sm">
                                <div className="w-8 h-8 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-lg flex items-center justify-center">
                                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 012 2h4a3 3 0 003 3v1" />
                                    </svg>
                                </div>
                ...
                <div className="flex-1 overflow-auto py-8 px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        <div className="animate-slide-up">
                                            ...
                                            <div className="flex items-center space-x-6">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <Text type="secondary">
                                                            Thông tin chi tiết về tài khoản và liên hệ
                                                        </Text>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div className="flex-1 text-center lg:text-left space-y-4">
                                                    <div>
                                                        ...
                                                        <Text className="text-lg text-indigo-600 font-medium">
                                                            Mã QL: {profile?.ma_gv || "Chưa cập nhật"}
                                                        </Text>
                                                    </div>

                                                    <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                                                        <Tag color="blue" className="px-4 py-2 text-sm font-medium flex items-center">
                                                            <BankOutlined className="mr-2" />
                                                            {profile?.bo_mon?.ten_bo_mon || "Chưa có bộ môn"}
                                                        </Tag>
                                                        <Tag color="purple" className="px-4 py-2 text-sm font-medium flex items-center">
                                                            <HomeOutlined className="mr-2" />
                                                            {profile?.bo_mon?.khoa?.ten_khoa || "Chưa có khoa"}
                                                        </Tag>
                                                        {profile?.trang_thai === 1 ? (
                                                            <Tag color="success" className="px-4 py-2 text-sm font-medium flex items-center">
                                                                <CheckCircleOutlined className="mr-2" />
                                                                Đang hoạt động
                                                            </Tag>
                                                        ) : (
                                                            <Tag color="error" className="px-4 py-2 text-sm font-medium flex items-center">
                                        ...
                                        <Col xs={24} lg={12}>
                                            <Card className="bg-white/95 backdrop-blur-lg border-gray-200/50 shadow-xl h-full" style={{ borderRadius: '16px' }}>
                                                <div className="bg-gradient-to-r from-slate-50 via-blue-50/50 to-indigo-50/50 px-6 py-4 border-b border-gray-200/50 -mx-6 -mt-6 mb-6 rounded-t-2xl">
                                                    <Title level={4} style={{ margin: 0 }} className="flex items-center">
                                                        <div className="w-8 h-8 bg-indigo-100 rounded-lg flex items-center justify-center mr-3">
                                                            <MailOutlined className="text-indigo-600" />
                                                        </div>
                                                        Thông tin liên hệ
                                                    </Title>
                                                    <Text type="secondary" className="text-sm mt-2">Thông tin cá nhân và liên lạc</Text>
                                                </div>
                                                ...
                                                <div className="space-y-6">
                                                    ...
                                                    <div className="group">
                                                        <div className="flex items-center p-4 bg-gradient-to-r from-gray-50 to-white rounded-xl border border-gray-100/50 hover:border-indigo-200/50 hover:shadow-md transition-all duration-300">
                                                            ...
                                                            <div className="flex-1">
                                                                <Text className="block text-sm text-gray-500 mb-1">Địa chỉ email</Text>
                                                    ...
                                                    <div className="group">
                                                        <div className="flex items-center p-4 bg-gradient-to-r from-gray-50 to-white rounded-xl border border-gray-100/50 hover:border-emerald-200/50 hover:shadow-md transition-all duration-300">
                                                            ...
                                                            <div className="flex-1">
                                                                <Text className="block text-sm text-gray-500 mb-1">Số điện thoại</Text>
                                        ...
                                        <Col xs={24} lg={12}>
                                            <Card className="bg-white/95 backdrop-blur-lg border-gray-200/50 shadow-xl h-full" style={{ borderRadius: '16px' }}>
                                                <div className="bg-gradient-to-r from-slate-50 via-blue-50/50 to-indigo-50/50 px-6 py-4 border-b border-gray-200/50 -mx-6 -mt-6 mb-6 rounded-t-2xl">
                                                    ...
                                                    <Text type="secondary" className="text-sm mt-2">Chi tiết về vị trí và đơn vị</Text>
                                                </div>
                                                ...
                                                <div className="space-y-6">
                                                    ...
                                                    <div className="p-6 bg-gradient-to-br from-emerald-50 to-green-50 rounded-xl border border-emerald-100/50 hover:shadow-lg transition-all duration-300 group">
                                                        ...
                                                        <Text className="text-lg font-bold text-emerald-800">
                                                            {profile?.bo_mon?.ten_bo_mon || "Chưa cập nhật"}
                                                        </Text>
                                                    </div>
                                                    ...
                                                    <div className="p-6 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl border border-purple-100/50 hover:shadow-lg transition-all duration-300 group">
                                                        ...
                                                        <Text className="text-lg font-bold text-purple-800">
                                                            {profile?.bo_mon?.khoa?.ten_khoa || "Chưa cập nhật"}
                                                        </Text>
                                                    </div>
                                                </div>
                                            </Card>
                            ...
                            ) : activeTab === "duyet-ke-khai" ? (
                                <DuyetKeKhai ma_gv={profile?.ma_gv} />
                            ) : activeTab === "thong-ke" ? (
                                <ManagerStatistics ma_gv={profile?.ma_gv} />
                            ) : (
                                <ExportReport ma_gv={profile?.ma_gv} />
                            )}
                        </div>
                    </div>
                </div>
                            ...
                            <div className="relative z-10 flex flex-col items-center text-center">
                                ...
                                <div className="mb-5">
                                    <div className="bg-gradient-to-r from-indigo-40/80 via-blue-50/80 to-purple-50/80 backdrop-blur-sm p-3 rounded-lg border border-indigo-200/20 mb-3 shadow-lg max-w-md mx-auto">
                                        <h2 className="text-lg font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 bg-clip-text text-transparent">
                                            Xin chào, {profile?.ho_ten || "Quản lý"}! 👋
                                        </h2>
                                        <p className="text-xs text-gray-600 font-medium mt-1">
                                            Chào mừng đến với hệ thống quản lý khối lượng giảng dạy
                                        </p>
                                    </div>
                                ...
                                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-2.5 mb-5 max-w-2xl">
                                    {[{
                                        ...
                                        title: "Duyệt kê khai",
                                        desc: "Phê duyệt hoạt động giảng dạy",
                                    ...
                                    },
                                    {
                                        ...
                                        desc: "Phân tích dữ liệu và báo cáo",
                                ...
                                <div className="w-full flex items-center justify-center gap-4 mb-5 p-3 bg-gradient-to-r from-gray-50/80 via-white/80 to-gray-50/80 backdrop-blur-sm rounded-lg border border-gray-200/50 max-w-md mx-auto">
                                    <div className="text-center">
                                        ...
                                        <div className="text-xs text-gray-600 font-medium">Quản lý nhanh</div>
                                    </div>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="text-sm font-bold text-purple-600 mb-1">Thông minh</div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-2.5 w-full max-w-md mx-auto">
                                    ...
                                    >
                                        <span className="flex items-center justify-center gap-2">
                                            ...
                                            <span className="text-sm">Bắt đầu quản lý</span>
                                    ...
                                    >
                                        <span className="flex items-center justify-center gap-2">
                                            ...
                                            <span className="text-sm">Duyệt ngay</span>
                                        </span>
                                    </button>
                                </div>
