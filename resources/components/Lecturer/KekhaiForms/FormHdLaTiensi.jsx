...
function FormHdLaTiensi({
    ...
    const handleModalOk = async () => {
        try {
            ...
            if (editingItem !== null && editingItem.index !== undefined) {
                ...
                message.success("Cập nhật thông tin hướng dẫn LA TS thành công.");
            } else {
                newData.push(newItem);
                message.success("Thêm mục hướng dẫn LA TS vào kê khai thành công.");
            }
    ...
    const columns = [
        ...
        },
        {
            ...
            width: 120,
            align: 'center',
            render: (text) => <Tag color={text === '3 năm' ? 'geekblue' : 'purple'}>{text}</Tag>
        },
        {
            title: 'SL HĐ Chính',
    ...
    return (
        <div style={{ marginBottom: '20px', padding: '10px', border: '1px solid #f0f0f0', borderRadius: '8px' }}>
            ...
            <Table
                ...
                bordered
                size="middle"
                locale={{ emptyText: 'Chưa có kê khai hướng dẫn Luận án Tiến sĩ.' }}
                summary={pageData => {
                        ...
                        dataSource && dataSource.length > 0 && (
                            <Table.Summary.Row style={{ background: '#fafafa' }}>
                                <Table.Summary.Cell index={0} colSpan={6} align="right">
                                    <Text strong>Tổng giờ Hướng dẫn LA TS:</Text>
                                </Table.Summary.Cell>
            ...
            >
                <Form form={form} layout="vertical">
                    ...
                    <Form.Item
                        ...
                        rules={[{ required: true, message: 'Vui lòng chọn loại hình đào tạo!' }]}
                        initialValue="4 năm"
                    >
                    ...
                    <Row gutter={16}>
                        <Col span={8}>
                            ...
                            >
                                <InputNumber min={0} style={{ width: '100%' }} placeholder="SL NCS" />
                            </Form.Item>
                        </Col>
                        <Col span={8}>
                            <Form.Item
