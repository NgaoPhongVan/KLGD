...
function HocKyManagement() {
    ...
    const debouncedSearch = useCallback(
        debounce((searchValue) => {
            ...
            fetchHocKy(1, pagination.per_page, searchValue);
        }, 500),
        [pagination.per_page]
    );
    ...
    useEffect(() => {
        if (searchTerm.trim() !== "") {
            ...
            fetchHocKy(1, pagination.per_page, "");
        }
    ...
    const fetchHocKy = async (page = pagination.current_page, perPage = pagination.per_page, search = searchTerm) => {
        setIsLoading(true);
        try {
            const params = {
                per_page: perPage,
    ...
    const handlePageChange = (page, pageSize) => {
        ...
        fetchHocKy(page, pageSize, searchTerm);
    };
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            if (editingId) {
                await axios.put(`/api/admin/hoc-ky/${editingId}`, values, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
                    },
                });
                ...
                await axios.post("/api/admin/hoc-ky", values, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
                    },
                });
    ...
    const handleEdit = (hocKy) => {
        form.setFieldsValue({
            ten_hoc_ky: hocKy.ten_hoc_ky,
            nam_hoc_id: hocKy.nam_hoc_id.toString(),
            la_ky_hien_hanh: hocKy.la_ky_hien_hanh.toString(),
        });
        setEditingId(hocKy.id);
    };
    ...
    const confirmDelete = async () => {
        ...
        try {
            ...
            let errorMessage = "Có lỗi xảy ra khi xóa học kỳ";
    ...
    const handleImport = async () => {
        ...
        try {
            const response = await axios.post("/api/admin/hoc-ky/import", formData, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
    ...
    const downloadSampleFile = () => {
        ...
        link.setAttribute('download', 'mau_danh_sach_hoc_ky.csv');
    ...
    const columns = [
        ...
        {
            title: 'Trạng thái',
            dataIndex: 'la_ky_hien_hanh',
            key: 'la_ky_hien_hanh',
            width: 150,
            render: (la_ky_hien_hanh) => (
                la_ky_hien_hanh ? (
                ...
                <Card className="bg-white/95 backdrop-blur-lg border-gray-200/50 shadow-xl" style={{ borderRadius: '16px' }}>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-6">
                            <div className="relative">
                                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-2xl shadow-lg flex items-center justify-center transform rotate-3 hover:rotate-0 transition-transform duration-300">
                                    <ScheduleOutlined className="text-2xl text-white" />
                                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <Text type="secondary">Quản lý danh sách học kỳ theo năm học</Text>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-2 text-xs text-gray-400">
                            ...
                            <span className="text-purple-600 font-medium">Quản lý học kỳ</span>
                        </div>
                    </div>
                </Card>
                ...
                <Card className="bg-white/95 backdrop-blur-lg border-gray-200/50 shadow-xl" style={{ borderRadius: '16px' }}>
                    <div className="bg-gradient-to-r from-slate-50 via-blue-50/50 to-indigo-50/50 px-6 py-4 border-b border-gray-200/50 -mx-6 -mt-6 mb-6 rounded-t-2xl">
                        <div className="flex items-center">
                            ...
                            <div>
                                <Title level={4} style={{ margin: 0 }}>Tìm kiếm học kỳ</Title>
                                <Text type="secondary" className="text-sm">Tìm kiếm theo tên học kỳ hoặc năm học</Text>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <Text type="secondary" className="text-sm">
                                    {editingId ? "Chỉnh sửa thông tin học kỳ hiện tại" : "Tạo học kỳ mới cho hệ thống"}
                                </Text>
                            </div>
                        </div>
                    </div>
                    ...
                    >
                        <Row gutter={[24, 24]}>
                            <Col xs={24} sm={8}>
                                <Form.Item
                                    name="ten_hoc_ky"
                                    label={<Text strong>Tên học kỳ</Text>}
                    ...
                    <div className="bg-gradient-to-r from-slate-50 via-emerald-50/50 to-teal-50/50 px-6 py-4 border-b border-gray-200/50 -mx-6 -mt-6 mb-6 rounded-t-2xl">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <Text type="secondary" className="text-sm">Tải lên file Excel hoặc CSV để thêm nhiều học kỳ</Text>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                                <div className="flex items-start">
                                    ...
                                    <div className="text-xs text-blue-800 flex-1">
                                        ...
                                        <Text className="block mt-1">File phải có cấu trúc đúng với các cột: ten_hoc_ky, nam_hoc_id, la_ky_hien_hanh</Text>
                                        <div className="mt-3 flex items-center justify-between">
                                            <Text className="text-blue-700">
                                                <strong>Ghi chú:</strong> nam_hoc_id phải tồn tại, la_ky_hien_hanh (0=Không hiện hành, 1=Kỳ hiện hành)
                                            </Text>
                                            <Button
                                                type="link"
                                                size="small"
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div className="text-xs text-amber-800">
                                        ...
                                        <ul className="list-disc list-inside mt-1 space-y-1">
                                            ...
                                            <li>Đảm bảo nam_hoc_id tương ứng với ID năm học trong hệ thống</li>
                                            <li>Chỉ được có 1 học kỳ hiện hành (la_ky_hien_hanh = 1) trong mỗi năm học</li>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="text-xs text-green-800">
                                            ...
                                            <div className="mt-2 grid grid-cols-2 gap-2">
                                                {namHocList.slice(0, 6).map((namHoc) => (
                                            ...
                                            {namHocList.length > 6 && (
                                                <Text className="text-green-600 text-xs mt-1">
                                                    và {namHocList.length - 6} năm học khác...
                                                </Text>
                                            )}
                                        </div>
                                    </div>
                            ...
                            <div className="mt-3 p-3 bg-purple-50 rounded-lg border border-purple-200">
                                <div className="flex items-start">
                                    ...
                                    <div className="text-xs text-purple-800">
                                        <Text strong className="block">Giá trị trạng thái (la_ky_hien_hanh):</Text>
                                        <div className="mt-2 grid grid-cols-1 gap-2">
                                            <div className="flex items-center space-x-2">
                                                <span className="font-mono text-purple-700 bg-purple-100 px-2 py-1 rounded">0</span>
                                                <span>Không hiện hành (học kỳ đã qua hoặc tương lai)</span>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                <span className="font-mono text-purple-700 bg-purple-100 px-2 py-1 rounded">1</span>
                                                <span>Kỳ hiện hành (học kỳ đang diễn ra)</span>
                                            </div>
                                        </div>
                                        <Text className="text-purple-600 text-xs mt-2 block">
                                            <strong>Lưu ý:</strong> Chỉ nên có 1 học kỳ hiện hành trong mỗi năm học
                                        </Text>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-gradient-to-r from-slate-50 via-purple-50/50 to-indigo-50/50 px-6 py-4 border-b border-gray-200/50 -mx-6 -mt-6 mb-6 rounded-t-2xl">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <Title level={4} style={{ margin: 0 }}>Danh sách học kỳ</Title>
                                    <Text type="secondary" className="text-sm">
                                        {searchTerm ? (
                                            `${pagination.total} kết quả tìm kiếm cho "${searchTerm}"`
                                        ) : (
                                            `${pagination.total} học kỳ trong hệ thống`
                                        )}
                                    </Text>
                                </div>
                            </div>
                            ...
                            emptyText: (
                                <div className="py-12 text-center">
                                    <div className="w-16 h-16 bg-gray-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
                                        <ScheduleOutlined className="text-2xl text-gray-400" />
                                    </div>
                                    <Text className="text-gray-500 font-medium text-lg block">
                                        {searchTerm ? `Không tìm thấy học kỳ với từ khóa "${searchTerm}"` : "Chưa có học kỳ nào"}
                                    </Text>
